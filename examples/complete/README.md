...
This directory contains an example usage of the **terraform-azure-aks** module. It demonstrates how to deploy an Azure Kubernetes Service cluster with complete infrastructure including custom private DNS zones, Key Vault integration, Log Analytics monitoring, system and user node pools with auto-scaling enabled.
