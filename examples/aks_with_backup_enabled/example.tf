...
module "aks" {
  ...
  backup_datasource_parameters = {
    included_namespaces              = ["kube-system"]
    volume_snapshot_enabled          = true
    cluster_scoped_resources_enabled = true
  }
  backup_storage_account           = "aksbackupsa"
  backup_container_name            = "backupaks"
  snapshot_resource_group_name     = "app-aks-backup-rg"
  snapshot_resource_group_location = "norwayeast"
}
