...
data "azurerm_application_gateway" "appgw" {
  ...
  resource_group_name = var.appgw_resource_group_name != null ? var.appgw_resource_group_name : var.resource_group_name
}
...
data "azurerm_resource_group" "appgw_rg" {
  count = var.enable && var.enable_ingress_application_gateway ? 1 : 0
  name  = try(var.appgw_resource_group_name != null ? var.appgw_resource_group_name : var.resource_group_name)
}
